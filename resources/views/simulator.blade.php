        ...
        <div class="container">
            ...
            <ul class="breadcrumbs_list">
                <li class = "breadcrumbs_item">
                        <a href="##" class="breadcrumsb_link">Головна сторінка</a>
                </li>
                <li class = "breadcrumbs_item">
                        <a href="##" class="breadcrumsb_link breadcrumbs_active">Симулятор слідчих дій</a>
                </li>                
            </ul>
            ...
            <div class="direction-wrapper">
                ...
                <div class="direction-inner">
                    <div class="direction-inner_top">
                        <img class="direction-inner_img" src="assets/img/direction_4.jpg" alt="img">
                ...
                <div class="direction-inner">
                    <div class="direction-inner_top">
                        <img class="direction-inner_img" src="assets/img/direction_5.jpg" alt="img">
                        <a class="image-btn" href="##">
                            <span>Підкатегорії</span>
                            <div class="image-btn_arrow"></div>
                        </a>
