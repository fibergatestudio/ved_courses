...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">{{ __('Создать тест') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('create_test') }}" id="test_form" method="POST" >
                        @csrf
                                ...
                                <div class="container-fluid"> 
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <input type="text" class="form-control" :name="'question[]'" style="display: inline-block" placeholder="Начало вопроса" >
                                        </div>
                                        <div class="col-sm">
                                            <div class="page-header text-center"> <h3> Варианты ответа </h3> <div @click="addNewAnswer(index)" class="btn btn-success m-1 text-center">Добавить Ответ</div></div><br>
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type="text" class="form-control" :name="'question_end[]'" style="display: inline-block" placeholder="Конец вопроса" >
                                        </div>
                                    </div>
                                </div>
