...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">{{ __('Добавление вопроса "Краткий ответ" к тесту') }} </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('create_short_answer',['test_info_id' => $test_info_id]) }}" id="test_form" method="POST" >
                        @csrf
                    <!-- Множественный выбор -->
