<div class="sidebar-menu_wrapper">
    <nav class="sidebar-menu_navigation">
        <ul class="sidebar_title-wrapper">
            ...
            <li class="sidebar_title-inner">
                <div class="sidebar_title-imgBox">
                    <a href="{{ route('courses_controll') }}"><img class="sidebar_title-image" src="/img/teacher-menu-2.png" alt="icon"></a>
                </div>
            ...
            <li class="sidebar_title-inner">
                <div class="sidebar_title-imgBox">
                    <a href="{{ route('users_controll') }}"><img class="sidebar_title-image" src="/img/teacher-menu-5.png" alt="icon"></a>
                </div>
