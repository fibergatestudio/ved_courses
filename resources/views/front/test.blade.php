                    ...
                    @foreach($testQuestions as $question)
                        ...
                        @if(count($testTrueFalse) >= 1)
                            @foreach($testTrueFalse as $trueFalse)
                                @if($trueFalse->id == $question->test_answers_id && $question->question_type == "Правильно/неправильно")
                        ...
                        @if(count($testMultiply) >= 1)
                            @foreach($testMultiply as $multiply)
                                @if($multiply->id == $question->test_answers_id && $question->question_type == "Множинний вибір")
                        ...
                        @if(count($testDragDrop) >= 1)
                            ...
                            @foreach($testDragDrop as $dragDrop)
                                @if($dragDrop->id == $question->test_answers_id && $question->question_type == "Перетягування в тексті")
