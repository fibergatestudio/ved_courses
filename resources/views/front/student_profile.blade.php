        ...
        <div class="container">
            ...
            <div class="profile-grid_wrapper">
                <div class="profile-grid_item">
                    <div class="profile-item_photo"></div>
                </div>
                <div class="profile-grid_item">
            ...
            <a class="btn-watch--more" href="javascript: void();" onclick="location.href='{{ route('student_information') }}'">
            ...
            @if( Auth::user()->getMedia('photos')->last())
                <style>
                    .profile-item_photo {
                        background-image: url("{{ Auth::user()->getMedia('photos')->last()->getUrl('thumb_big') }}") !important;
