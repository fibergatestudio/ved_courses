        ...
        <div class="container">
            ...
            <ul class="breadcrumbs_list">
                <li class = "breadcrumbs_item">
                        <a style="font-size:18px" style="color:#0000ff" href="{{url('/main')}}" class="breadcrumbs_link">Головна сторінка</a>
                </li>
                <li class = "breadcrumbs_item">
            ...
            <div class="simulatorBig-article_wrapper">
                <div style="font-size:18px" class="simulatorBig-article_inner">
