...
class CreateTestsMultipleChoiceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tests_multiple_choice', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tests_multiple_choice');
    }
}
